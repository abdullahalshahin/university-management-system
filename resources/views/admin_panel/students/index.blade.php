                                        ...
                                        <tr>
                                            ...
                                            <td class="table-user">
                                                @if ($student->profile_image)
                                                    <img src="{{ url('images/students', $student->profile_image) }}" alt="profile_image" class="me-2 rounded-circle" />
                                                @else
                                                    <img src="{{ asset('assets/images/avator.png') }}" alt="profile_image" class="me-2 rounded-circle" />
                                                @endif

                                                <a href="{{ url('admin-panel/dashboard/students', $student->id) }}" class="text-body fw-se mibold"> {{ $student->full_name ?? "" }} </a>
                                            </td>
                                            ...
                                            <td>
                                                <form action="{{ url('admin-panel/dashboard/students', $student->id) }}" method="POST">
                                                    ...
                                                    <a href="{{ url('admin-panel/dashboard/students', $student->id) }}" class="action-icon"> <i class="mdi mdi-eye"></i></a>
                                                    <a href="{{ url('admin-panel/dashboard/students/'. $student->id . '/edit') }}" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>

<x-app-layout>
    <x-slot name="page_title">{{ $page_title ?? 'Courses |' }}</x-slot>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-sm-5">
                                <a href="{{ url('admin-panel/dashboard/courses/create') }}" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle me-2"></i> Add Course </a>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($courses as $key => $course)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ url('admin-panel/dashboard/courses', $course->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')

                                                    <a href="{{ url('admin-panel/dashboard/courses', $course->id) }}" class="action-icon"> <i class="mdi mdi-eye"></i></a>
                                                    <a href="{{ url('admin-panel/dashboard/courses/'. $course->id . '/edit') }}" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>

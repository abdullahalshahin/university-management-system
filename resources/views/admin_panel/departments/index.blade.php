<x-app-layout>
    <x-slot name="page_title">{{ $page_title ?? 'Departments |' }}</x-slot>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-sm-5">
                                <a href="{{ url('admin-panel/dashboard/departments/create') }}" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle me-2"></i> Add Department </a>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($departments as $key => $department)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ url('admin-panel/dashboard/departments', $department->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')

                                                    <a href="{{ url('admin-panel/dashboard/departments', $department->id) }}" class="action-icon"> <i class="mdi mdi-eye"></i></a>
                                                    <a href="{{ url('admin-panel/dashboard/departments/'. $department->id . '/edit') }}" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>

    ...
    <body>
        <div class="wrapper">
                ...
                <div class="topbar container-fluid">
                    <div class="d-flex align-items-center gap-lg-2 gap-1">
                        <div class="logo-topbar">
                            <a href="{{ url('admin-panel/dashboard') }}" class="logo-light">
                                <span class="logo-lg">
                            ...
                            <a href="{{ url('admin-panel/dashboard') }}" class="logo-dark">
                                <span class="logo-lg">
                    ...
                    <ul class="topbar-menu d-flex align-items-center gap-3">
                        ...
                        <li class="dropdown">
                            <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                <span class="account-user-avatar">
                                    @if (Auth::user()->profile_image)
                                        <img src="{{ url('images/users', Auth::user()->profile_image) }}" alt="{{ Auth::user()->name ?? "" }}" width="32" class="rounded-circle">
                                    @else
                                        <img src="{{ asset('assets/images/avator.png') }}" alt="{{ Auth::user()->name ?? "" }}" width="32" class="rounded-circle">
                                    @endif
                                </span>
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated profile-dropdown">
                                ...
                                <a href="{{ url('admin-panel/dashboard/my-account') }}" class="dropdown-item">
            ...
            <div class="leftside-menu">
                <a href="{{ url('admin-panel/dashboard') }}" class="logo logo-light">
                    <span class="logo-lg">
                        <img src="{{ asset('assets/images/logo.png') }}" alt="logo">
                    </span>
                    <span class="logo-sm">
                ...
                <a href="{{ url('admin-panel/dashboard') }}" class="logo logo-dark">
                    <span class="logo-lg">
                ...
                <div class="h-100" id="leftside-menu-container" data-simplebar>
                    <div class="leftbar-user">
                        <a href="pages-profile.html">
                            @if (Auth::user()->profile_image)
                                <img src="/images/clients/{{ Auth::user()->profile_image }}" alt="{{ Auth::user()->name ?? "" }}" height="42" class="rounded-circle shadow-sm">
                            @else
                                <img src="{{ asset('assets/images/avator.png') }}" alt="{{ Auth::user()->name ?? "" }}" height="42" class="rounded-circle shadow-sm">
                            @endif
                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarDashboards">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="{{ url('admin-panel/dashboard') }}"> Analysis </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="side-nav-item">
                            <a href="{{ url('admin-panel/dashboard/branches') }}" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            <a href="{{ url('admin-panel/dashboard/departments') }}" class="side-nav-link">
                                <i class="uil-clipboard-alt"></i>
                        ...
                        @canany(['recycle_bin_student_view', 'recycle_bin_user_view'])
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="RecycleBin">
                                    <ul class="side-nav-second-level">
                                        @can('recycle_bin_student_view')
                                            <li>
                                                <a href="{{ url('admin-panel/dashboard/recycle-bin/students') }}"> Student </a>
                                            </li>
                                        @endcan

                                        @can('recycle_bin_user_view')
                                            <li>
                                                <a href="{{ url('admin-panel/dashboard/recycle-bin/users') }}"> User </a>
                                            </li>
                                        @endcan
                                    </ul>
                                </div>
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="UserManagement">
                                    <ul class="side-nav-second-level">
                                        ...
                                        @can('role_view')
                                            <li>
                                                <a href="{{ url('admin-panel/dashboard/roles') }}"> Role & Permissions </a>
                                            </li>
                                        @endcan
                                    </ul>
                                </div>
                        ...
                        @canany(['application_configuration', 'system_cache_clear'])
                            <li class="side-nav-item">
                                <a href="{{ url('admin-panel/dashboard/system-settings') }}" class="side-nav-link">
                                    <i class="uil-cog"></i>
                        ...
                        @canany(['profile_view', 'profile_edit'])
                            <li class="side-nav-item">
                                <a href="{{ url('admin-panel/dashboard/my-account') }}" class="side-nav-link">
